...
export default function SecurityDrawer({ isOpen, onClose, email }: SecurityDrawerProps) {
    ...
    return (
        <>
            ...
            {/* Drawer */}
            <div className={`fixed right-0 top-0 bottom-0 w-full max-w-sm bg-white shadow-2xl z-50 transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
                <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        <div className="bg-zinc-50 p-4 rounded-xl border border-zinc-100">
                            <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-2">Account Context</h4>

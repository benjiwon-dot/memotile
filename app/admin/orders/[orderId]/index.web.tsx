                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-zinc-500">
                            {deniedReason === "NO_USER" &&
                                "You must be logged in to access the order details."}
                            {deniedReason === "NOT_ALLOWED_EMAIL" &&
                                "This account is not authorized to view admin order details."}
                            {deniedReason === "NOT_ADMIN" &&
                                "Your account lacks the isAdmin privilege."}
                            {deniedReason === "ERROR" &&
